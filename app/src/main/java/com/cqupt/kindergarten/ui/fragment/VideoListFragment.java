...
public class VideoListFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private static final String COLLEGE_VIDEO_LIST_URL = "http://172.20.2.164:8080/kindergarden/MCShowAdmini";
    private static final String CLASS_VEDIO_LIST_URL = "http://172.20.2.164:8080/kindergarden/MCClassApp";
