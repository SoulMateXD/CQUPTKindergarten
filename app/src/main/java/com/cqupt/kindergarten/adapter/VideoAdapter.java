...
public class VideoAdapter extends RecyclerView.Adapter<VideoAdapter.MyViewHolder> implements View.OnClickListener{
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        Glide.with(context)
                .load(bean.getVideoImageUrl())
                .placeholder(R.drawable.default_image)
                .into(holder.videoImage);
        holder.videoDate.setText(bean.getDate());
        holder.videoTime.setText(bean.getVideoTime());
        if (bean.getCollect()){
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.item_video_message_icon:
                int position2 = (int) v.getTag(R.id.video_adapter_position);
                onClickListener.onVideoCommentClicked(position2);
        }
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            videoTime = (TextView) itemView.findViewById(R.id.item_video_time_long);
